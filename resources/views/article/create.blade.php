...
@endif
            ...
            <form>
  <div class="mb-3">
    <form method="post" action="{{ route('article.store') }}"encytype="multipart/form-data"></form>
    <label for="Title" class="form-label">Titolo:</label>
    <input type="text" name="title" class="form-control" id="exampleInputEmail1" aria-describedby="titleHelp" value="{{ old('title') }}">
    
  </div>
  <div class="mb-3">
    <label for="director" class="form-label">Regista:</label>
    <input type="text" name="director" class="form-control" id="regista" aria-describedby="directorHelp" value="{{ old('director') }}">
  ...
  <div class="mb-3">
    ...
    <textarea name="plot" id="" cols="30" rows="10" class="form-control" value="">{{ old('plot') }}</textarea>
  </div>
